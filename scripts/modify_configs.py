...
parser.add_argument('--max_epoch', '-ep', type=str, default='', help='epoch numbers')
parser.add_argument('--inputs', '-in', type=str, default='', help='inputs')
parser.add_argument('--fusion_stage', '-fs', type=str, default='', help='fusion_stage')
...
for file in os.listdir('./configs'):
    ...
    for line in lines:
        ...
        elif 'gpus:' in line and args.gpus != '':
            new_line = f'gpus: {args.gpus}\n'
        elif 'max_epoch:' in line and args.max_epoch != '':
            new_line = f'    max_epoch: {args.max_epoch}\n'
        elif 'inputs:' in line and args.inputs != '':
            new_line = f'    inputs: {args.inputs}\n'
        elif 'fusion_stage:' in line and args.fusion_stage != '':
            new_line = f'  fusion_stage: {args.fusion_stage}\n'
        else:
            new_line = line
        fr.write(new_line)
    fr.close()
